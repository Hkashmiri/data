...
public class Circle {
    ...
    public boolean contains(Point p) {
        double distance = Math.sqrt(Math.pow(location.getX() - p.getX(), 2) + Math.pow(location.getY() - p.getY(), 2));
    ...
    public boolean intersects(Circle aCircle) {
        double distanceBetweenCenters = Math.sqrt(Math.pow(location.getX() - aCircle.getLocation().getX(), 2) + Math.pow(location.getY() - aCircle.getLocation().getY(), 2));
        return (radius + aCircle.getRadius()) >= distanceBetweenCenters;
    }
